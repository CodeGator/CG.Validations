...
public static partial class GuardExtensions
{
    ...
    /// <example>
    /// This example shows how to call the <see cref="GuardExtensions.ThrowIfInvalidObject(IGuard, object, string, string, string, int)"/>
    /// method.
    /// <code>
    ...
    /// </code>
    /// </example>
    public static IGuard ThrowIfInvalidObject(
        this IGuard guard,
        object argValue,
        string argName,
        ...
        )
    {
        ...
        {
            // Format the invalid property names.
            var propertyNames = string.Join(
                ",",
                validationResults.Select(x => string.Join(",", x.MemberNames))
                );
            ...
            throw new ArgumentException(
                message: string.Format(
                    ...
                    Resources.ObjectPropValidation,
    ...
    /// <example>
    /// This example shows how to call the <see cref="GuardExtensions.ThrowIfNull(IGuard, object, string, string, string, int)"/>
    /// method.
    /// <code>
    /// class TestClass
    /// {
    ...
    /// <example>
    /// This example shows how to call the <see cref="GuardExtensions.ThrowIfNullOrEmpty(IGuard, string, string, string, string, int)"/>
    /// method.
    /// <code>
    /// class TestClass
    /// {
    ...
    /// </exception>
    /// <example>
    /// This example shows how to call the <see cref="GuardExtensions.ThrowIfEqual(IGuard, long, long, string, string, string, int)"/>
    /// method.
    /// <code>
    /// class TestClass
    /// {
    ...
    /// </exception>
    /// <example>
    /// This example shows how to call the <see cref="GuardExtensions.ThrowIfEqual(IGuard, int, int, string, string, string, int)"/>
    /// method.
    /// <code>
    /// class TestClass
    /// {
    ...
    /// </exception>
    /// <example>
    /// This example shows how to call the <see cref="GuardExtensions.ThrowIfNotEqual(IGuard, long, long, string, string, string, int)"/>
    /// method.
    /// <code>
    /// class TestClass
    /// {
    ...
    /// </exception>
    /// <example>
    /// This example shows how to call the <see cref="GuardExtensions.ThrowIfNotEqual(IGuard, int, int, string, string, string, int)"/>
    /// method.
    /// <code>
    /// class TestClass
    /// {
